...
public class Shooter{
    ...
    public static void shoot(boolean pressed) {
        if (pressed) {
            ...
            masterShooterTalon.set(ControlMode.PercentOutput, Constants.TOP_MOTOR_SPEED_LINE);
            followerTalon.set(ControlMode.PercentOutput, Constants.TOP_MOTOR_SPEED_LINE);
        } else {
    ...
    public static void reverseHopperPower(double power){
        hopperTalon.setInverted(false);
        hopperTalon.set(ControlMode.PercentOutput, power);
    }
